  ...
  const handleGeneratePDF = () => {
    try {
      ...
      autoTable(doc, {
        ...
        body: [
          ["Transaction Velocity Risk", `${bd.transactionRisk || 0} pts`, "20 pts", bd.transactionRisk > 12 ? "Elevated" : "Normal"],
          ["Balance Exposure Risk", `${bd.balanceRisk || 0} pts`, "15 pts", bd.balanceRisk > 8 ? "Whale Balance" : "Standard"],
          ["Transit Pattern Risk", `${bd.patternRisk || 0} pts`, "20 pts", bd.patternRisk > 12 ? "High Churn" : "Clean"],
          ["Activity & Age Consistency", `${bd.activityRisk || 0} pts`, "15 pts", bd.activityRisk > 8 ? "Dormant/Burst" : "Normal"],
          ["Entity & Sanctions Exposure", `${bd.entityRisk || 0} pts`, "30 pts", bd.entityRisk > 10 ? "Sanction/Mixer Associated" : "Clean"],
        ],
        theme: "striped",
